...
Out of 5:
1: Use map.
1: Return the variable that saved inside what map return (result in this case).
1: Pass element to the callback function or any name as the first parameter.
1: Return element - the first parameter in the main function(num in this case).
1: Final answer 100% correct.
*/
...
Out of 5:
1: Use reduce.
1: Return the variable that saved inside what reduce return and divides it by array length (result in this case).
1: Pass element to the callback acc, element
